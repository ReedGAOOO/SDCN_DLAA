...
for epoch in range(num_epochs):
    ...
    for batch_data in loader:
        ...
        output, intermediates = model(batch_data, return_intermediate=True)  # This enables intermediate outputs

        # Print intermediate output shapes for debugging
